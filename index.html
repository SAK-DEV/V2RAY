...
<head>
  ...
  <!-- Material font and icons -->
  <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500&display=swap" rel="stylesheet">
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">

  <!-- Styles (Do not change per user request) -->
  <style>
    body {
...
<body>
  ...
  <script>
    ...
    // Decodes base64 string to UTF-8 text (for proper emoji rendering)
    ...
    // Splits decoded block into multiple config strings
    ...
    // Creates a QR element with clickable image and copy text
    ...
    form.onsubmit = async e => {
      ...
      try {
        ...
        // Decode base64 with proper UTF-8 decoding
        ...
        qrSub.innerHTML = `<h2>🔗 Subscription Link</h2>`;
